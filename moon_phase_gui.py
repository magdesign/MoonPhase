...
# -------------------------- GET TIME ------------------------------------ #
	def get_time(self, *args):
		...
		# Get the Python date object from the calendar
...
# ----------------------- CREATE WIDGETS --------------------------------- #
	def create_widgets(self):
		...
		# Bind the calendar's date selection event to the get_time method
		self.cal.bind("<<CalendarSelected>>", self.get_time)
